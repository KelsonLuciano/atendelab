...
class UsuariosController
{
    ...
    public function listar(): void
    {
        ...
        $sql = 'SELECT id, nome, email, perfil, status, criado_em, atualizado_em FROM usuarios ORDER BY id DESC';
    ...
    public function buscarPorId(): void
    {
        ...
        $sql = 'SELECT id, nome, email, perfil, status, criado_em, atualizado_em FROM usuarios WHERE id = :id';
