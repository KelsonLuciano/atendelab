...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/06/2026 às 17:16
...
(1, 1, 1, 1, '2023-11-15', '14:30:00', 'O aluno relatou que não consegue acessar o portal das notas.', 'Solicitado reset de senha ao setor de TI.', 'pendente', '2026-06-17 23:32:00');
...
(1, 'teste', '123456789', '47999999999', 'teste', '5', 'ativo');
...
(1, 'Suporte Técnico', 'Atendimento focado em resolver problemas com o portal do aluno ou equipamentos.', 'ativo');
...
(1, 'Administrador', 'admin@atendelab.com', '$2y$10$FrraKu/JafV2bUCoX3D0qudyFlH5jP6DwjTjFG11K.wINxcwcsSXO', 'admin', 'ativo', '2026-06-11 00:02:49'),
(3, 'João Teste Atualizado', 'joao.atualizado@atendelab.com', '$2y$10$r3LD9PqIZKaxI1kikPyd2etC7Jc.n29xNCtWT/1FTpyp.9f5IsCxS', 'atendente', 'ativo', '2026-06-11 00:28:13'),
(4, 'Maria Luiza', 'maria.luiza@atendelab.com', '$2y$10$35tsLF9xxkoSvEecbTGatuXnciT1u84g3BnYj5xkk87bP.uh6lwzS', 'aluno', 'ativo', '2026-06-11 00:29:24');
